...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.btn_disconnect, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser, 2, 2, 9, 1)
        self.checkBox = QtWidgets.QCheckBox(self.frame_sender)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.frame_connect.setGeometry(QtCore.QRect(0, 0, 560, 220))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "multiply server"))
